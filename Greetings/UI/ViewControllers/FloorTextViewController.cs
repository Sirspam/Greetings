...
namespace Greetings.UI.ViewControllers
{
	...
	public class FloorTextViewController : BSMLAutomaticViewController
	{
		...
		private void CreateScreen()
		{
			...
			_floatingScreen = FloatingScreen.CreateFloatingScreen(new Vector2(100f, 50f), false, new Vector3(0f, 0.1f, 1.5f), new Quaternion(0.5f,0f,0f, 1f));
		...
		{
			if (_floatingScreen == null) CreateScreen();
